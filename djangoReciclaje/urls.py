"""
URL configuration for djangoReciclaje project.
...
urlpatterns = [
    ...
    path('api/events/', include('events.api_urls')),  # Rutas de la API para events
]

# Servir archivos de medios en el entorno de desarrollo
if settings.DEBUG:
